...
# Add routes for BatchEditController:
<pre>
  mount Hydra::BatchEdit::Engine => '/batch'
</pre>
...
You will need to set BatchEditController.type -- currently only allows updating _one_ type of content
