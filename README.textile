...
The main thrust of the re-usable functionality we aim to provide:

# Jackie User constructs a batch of objects from Blacklight/Hydra search results
# When Jackie has selected everything for the batch, she proceeds to the next step
...
# Before displaying the next step, a controller before_filter makes sure Jackie has edit permissions for each of the objects
...
The batches are tracked in user session as a list of pids.  They are not persisted.
